...
//              });
            ...
            <?php } else {?> 
                ...
                if(checkLoggedInUser !== null){
                    ...
                    if(checkLoggedInUser == onetimepasswordFromFirebase){                        
                        <?php                         
                         $requestFirebaseData =  authenticateFirebase();
                         $authData = json_decode($requestFirebaseData, true);
                        ?>

                    // firebase.auth().signInWithCustomToken("<?php echo $authData['refreshToken'];?>").catch(function(error) {
        ...
        $(document).on('click', "#enterOneTimePasswordBtn", function() {            
            ...
            if(oneTimePassword.toLowerCase().trim() == onetimepasswordFromFirebase.toLowerCase().trim()){
                ...
                console.log("password not matching at all....");
                swal({
                    type: 'error',
                    title: 'Oops...',
